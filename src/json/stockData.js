const stockData = [
  {
    ...
    topStocks: [
      { code: 'CRDA', stockName: 'CRODA INTERNATIONAL PLC', price: 4807.0 },
      { code: 'GSK', stockName: 'GSK PLC', price: 1574.8 },
      { code: 'ANTO', stockName: 'ANTOFAGASTA PLC', price: 1746.0 },
      { code: 'FLTR', stockName: 'FLUTTER ENTERTAINMENT PLC', price: 16340.0 },
      { code: 'BDEV', stockName: 'BARRATT DEVELOPMENTS PLC', price: 542.6 },
    ],
  },
  {
    code: 'NYSE',
    ...
    topStocks: [
      ...
      { code: 'KUKE', stockName: 'Kuke Music Holding Ltd', price: 1.2 },
